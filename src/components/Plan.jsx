...
const Plan = () => {
    return(
        <div className="max-w-[1400px] m-aut py-16 px-4 grid lg:grid-cols-2 gap-4 ">
            ...
            <div className="flex flex-col h-full justify-center">
                ...
                <p className="text-2xl py-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, dolore!</p>
                <p className="pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique debitis sapiente rem impedit voluptates perspiciatis dolores animi, odio corporis exercitationem, a doloribus temporibus molestias quisquam blanditiis dignissimos necessitatibus! Soluta, cupiditate?</p>
                <div>
